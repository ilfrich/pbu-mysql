...
from pbu import Logger, JsonDocument
...
class AbstractMysqlStore(ABC):
    ...
    def __init__(self, connection, table_name, object_class, logger=None):
        """
        ...
        :param logger: a logger for the Python logging framework
        """
